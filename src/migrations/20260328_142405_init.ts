...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_knives_status" AS ENUM('in_stock', 'custom_order');
  ...
  CREATE TABLE "knives" (
  	...
  	"status" "enum_knives_status" DEFAULT 'in_stock' NOT NULL,
  	"price" numeric,
  	"category_id" integer,
  	"description" jsonb,
  	"specs_manufacturer" varchar,
  	"specs_country" varchar,
  	"specs_steel" varchar,
  	"specs_hardness" varchar,
  	"specs_blade_length" varchar,
  	"specs_edge_length" varchar,
  	"specs_handle_length" varchar,
  	"specs_total_length" varchar,
  	"specs_blade_height" varchar,
  	"specs_thickness" varchar,
  	"specs_weight" varchar,
  	"specs_finish" varchar,
  	"specs_layers" varchar,
  	"specs_handle_material" varchar,
  	"specs_bolster" varchar,
  	"specs_sharpening_angle" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  
  CREATE TABLE "knives_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  ...
  CREATE TABLE "homepage_reviews_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  ALTER TABLE "homepage_reviews_rels" ADD CONSTRAINT "homepage_reviews_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."homepage_reviews"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "homepage_reviews_rels" ADD CONSTRAINT "homepage_reviews_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "homepage_reviews_rels_order_idx" ON "homepage_reviews_rels" USING btree ("order");
  CREATE INDEX "homepage_reviews_rels_parent_idx" ON "homepage_reviews_rels" USING btree ("parent_id");
  CREATE INDEX "homepage_reviews_rels_path_idx" ON "homepage_reviews_rels" USING btree ("path");
  CREATE INDEX "homepage_reviews_rels_media_id_idx" ON "homepage_reviews_rels" USING btree ("media_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "knives" CASCADE;
  DROP TABLE "knives_rels" CASCADE;
  ...
  DROP TABLE "homepage_reviews" CASCADE;
  DROP TABLE "homepage_reviews_rels" CASCADE;
  DROP TYPE "public"."enum_users_roles";
  DROP TYPE "public"."enum_knives_status";
